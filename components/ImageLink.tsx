...
const ImageLink: React.FC<Props> = ({ src, alt, href = "#", size }) => (
  <div className="relative overflow-hidden rounded group">
    <a href={href} target="_blank" rel="noreferrer">
      <div className="relative shadow-lg border rounded border-neutral-50/20 overflow-hidden" style={{ height: size }}>
